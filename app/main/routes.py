...
def send_message(recipient):
    ...
    own = user.messages_received.filter_by(sender_id=current_user.id)
    message = user.messages_sent.filter_by(recipient_id=current_user.id).union(own).order_by(Message.timestamp.desc())
